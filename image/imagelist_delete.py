...
# -*- coding: utf-8 -*-
"""
易盾反垃圾云服务图片名单删除接口python示例代码
接口文档: http://dun.163.com/api.html
python版本：python3.7
运行:
    1. 修改 SECRET_ID,SECRET_KEY,BUSINESS_ID 为对应申请到的值
    2. $ python imagelist_delete.py
"""
...
class ImageListDeleteDemo(object):
    """易盾反垃圾云服务图片名单删除接口python示例代码"""

    API_URL = "http://as.dun.163.com/v1/image/list/delete"
    VERSION = "v1.0"
...
if __name__ == "__main__":
    ...
    api = ImageListDeleteDemo(SECRET_ID, SECRET_KEY, BUSINESS_ID)
