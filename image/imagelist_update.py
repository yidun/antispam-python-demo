...
# -*- coding: utf-8 -*-
"""
易盾反垃圾云服务图片名单更新接口python示例代码
接口文档: http://dun.163.com/api.html
python版本：python3.7
运行:
    1. 修改 SECRET_ID,SECRET_KEY,BUSINESS_ID 为对应申请到的值
    2. $ python imagelist_update.py
"""
...
class ImageListUpdateDemo(object):
    """易盾反垃圾云服务图片名单更新接口python示例代码"""

    API_URL = "http://as.dun.163.com/v1/image/list/update"
    VERSION = "v1.0"
...
if __name__ == "__main__":
    ...
    api = ImageListUpdateDemo(SECRET_ID, SECRET_KEY, BUSINESS_ID)

    # 私有请求参数
    params = {
        "type": "1",
        "uuid": "512e7771c3074621914ae1894e0df5c1",
        "status": "0"
    }
