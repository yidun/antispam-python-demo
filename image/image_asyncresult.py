...
# -*- coding: utf-8 -*-
"""
易盾反垃圾云服务图片离线检测结果查询接口python示例代码
接口文档: http://dun.163.com/api.html
python版本：python3.7
运行:
    1. 修改 SECRET_ID,SECRET_KEY,BUSINESS_ID 为对应申请到的值
    2. $ python image_asyncresult.py
"""
...
class ImageAsyncResultAPIDemo(object):
    """图片离线检测结果查询接口示例代码"""

    API_URL = "http://as.dun.163.com/v4/image/asyncResult"
    VERSION = "v4"
...
if __name__ == "__main__":
    ...
    api = ImageAsyncResultAPIDemo(SECRET_ID, SECRET_KEY, BUSINESS_ID)

    # 私有请求参数
    taskIds: list = ["202b1d65f5854cecadcb24382b681c1a", "0f0345933b05489c9b60635b0c8cc721"]
    params = {
        "taskIds": json.dumps(taskIds)
    }
