...
# -*- coding: utf-8 -*-
"""
易盾反垃圾云服务名单提交接口python示例代码
接口文档: http://dun.163.com/api.html
python版本：python3.7
运行:
    1. 修改 SECRET_ID,SECRET_KEY,BUSINESS_ID 为对应申请到的值
    2. $ python list_submit.py
"""
...
class KeywordSubmitAPIDemo(object):
    ...
    API_URL = "https://as.dun.163yun.com/v1/list/submit"
    VERSION = "v1"
...
if __name__ == "__main__":
    ...
    api = KeywordSubmitAPIDemo(SECRET_ID, SECRET_KEY)

    # 私有请求参数
    lists: list = ["用户名单1", "用户名单2"]
    params = {
