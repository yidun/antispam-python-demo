...
# -*- coding: utf-8 -*-
"""
易盾反垃圾云服务投诉举报解决方案结果获取接口python示例代码
接口文档: http://dun.163.com/api.html
python版本：python3.7
运行:
    1. 修改 SECRET_ID,SECRET_KEY 为对应申请到的值
    2. $ python report_callback.py
"""
...
class ReportCallbackAPIDemo(object):
    """投诉举报解决方案结果获取接口"""

    API_URL = "http://as.dun.163.com/v1/report/callback/results"
    VERSION = "v1"
...
if __name__ == "__main__":
    ...
    api = ReportCallbackAPIDemo(SECRET_ID, SECRET_KEY)
