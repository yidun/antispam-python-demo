...
# -*- coding: utf-8 -*-
"""
易盾反垃圾云服务数字阅读解决方案结果获取接口python示例代码
接口文档: http://dun.163.com/api.html
python版本：python3.7
运行:
    1. 修改 SECRET_ID,SECRET_KEY 为对应申请到的值
    2. $ python digital_callback.py
"""
...
class DigitalCallbackAPIDemo(object):
    """数字阅读解决方案结果获取接口"""

    API_URL = "http://as.dun.163.com/v2/digital/callback/results"
    VERSION = "v2"
...
if __name__ == "__main__":
    ...
    api = DigitalCallbackAPIDemo(SECRET_ID, SECRET_KEY)
