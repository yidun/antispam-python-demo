#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""易盾反垃圾云服务数字阅读解决方案结果查询接口python示例代码
接口文档: http://dun.163.com/api.html
python版本：python3.7
运行:
    1. 修改 SECRET_ID,SECRET_KEY,BUSINESS_ID 为对应申请到的值
    2. $ python digital_query.py
"""
...
class DigitalQueryByTaskIdsDemo(object):
    """数字阅读解决方案结果查询接口示例代码"""

    API_URL = "http://as.dun.163.com/v2/digital/callback/query"
    VERSION = "v2"
...
if __name__ == "__main__":
    ...
    api = DigitalQueryByTaskIdsDemo(SECRET_ID, SECRET_KEY, BUSINESS_ID)
