...
# -*- coding: utf-8 -*-
"""
易盾反垃圾云服务直播电视墙人审操作记录获取接口python示例代码
接口文档: http://dun.163.com/api.html
python版本：python3.7
运行:
    1. 修改 SECRET_ID,SECRET_KEY,BUSINESS_ID 为对应申请到的值
    2. $ python livewall_querymonitor.py
"""
...
class LiveWallQueryMonitorAPIDemo(object):
    """直播电视墙人审操作记录获取接口示例代码"""

    API_URL = "http://as.dun.163.com/v1/livewall/query/monitor"
    VERSION = "v1.0"
...
if __name__ == "__main__":
    ...
    api = LiveWallQueryMonitorAPIDemo(SECRET_ID, SECRET_KEY, BUSINESS_ID)
