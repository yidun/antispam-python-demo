#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""易盾反垃圾云服务融媒体解决方案结果查询接口python示例代码
...
class MediaSolutionQueryByTaskIdsDemo(object):
    """融媒体解决方案结果查询接口示例代码"""

    API_URL = "http://as.dun.163.com/v2/mediasolution/callback/query"
    VERSION = "v2"
...
if __name__ == "__main__":
    ...
    api = MediaSolutionQueryByTaskIdsDemo(SECRET_ID, SECRET_KEY, BUSINESS_ID)
